...
const collectionItems: CollectionItem[] = [
  {
    ...
    tagline: "Kannan Deven Hills CTC Blended with Hand-Ground Organic Spices",
    type: "Warming Black Tea",
    ingredients: "Kannan Deven Hills CTC Tea, Cardamom, Cinnamon, Cloves, Ginger, Black Pepper",
    ...
    description: "Our signature blend crafted from select gardens in Kannan Deven Hills. We hand-grind the spices in traditional stone mills just hours before blending to preserve their vital aromatic oils, delivering a robust cup with a pleasant, lingering warmth.",
  ...
  },
  {
    ...
    ingredients: "Kannan Deven Hills Black Tea, Sun-Dried Ginger Root Granules, Ginger Extract",
    brewingTemp: "95°C / 203°F",
    brewingTime: "3 Mins",
    caffeine: "Medium",
    strength: 4,
